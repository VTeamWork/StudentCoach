            ...
            <form id="sign_up" method="POST" runat="server">
                ...
                <div>
                 ...
                 <div class="input-group">
                    ...
                    <div class="form-line">
                        <asp:TextBox runat="server" ID="SKYPE" CssClass="form-control" required="required" placeholder="Skype"></asp:TextBox>
                        <%--<input type="text" class="form-control" name="namesurname" placeholder="Name Surname" required autofocus>--%>
                    </div>
                </div>
                   ...
                   <b>Enrollment Date</b>
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                ...
                                                <asp:TextBox runat="server" TextMode="Date" ID="ENROL_DATE" CssClass="form-control date" required="required" placeholder="Ex: 30/07/2016"></asp:TextBox>
