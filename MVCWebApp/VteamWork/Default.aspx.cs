...
namespace VteamWork
{
    public partial class ViewDefaultStuQues : System.Web.UI.Page
    {
        ...
        {
            return LoginHelper.db.tbl_MODULE.Where(c => c.PARENT_MODULE_ID == null && c.IS_DEFAULT=="1").OrderBy(x => x.MODULE_NAME).ToList();
