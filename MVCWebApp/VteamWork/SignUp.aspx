            ...
            <div class="body">
                <form id="sign_up" method="POST">
                  ...
                  <%--  <button class="btn btn-block btn-lg bg-pink waves-effect" type="submit">SIGN UP</button>--%>
                    ...
                    <asp:Button CssClass="btn btn-default waves-effect" runat="server" Text="Sign In" />
                            <%--<asp:Button OnClick="Rigestered_Click" CssClass="btn btn-default waves-effect" runat="server" Text="Sign UP" />--%>
